...
#define USERNAME                    "A123456789123456789D"  			// There will be some guides
#define PASSWORD					"TEST1234"							// There will be some guides
#define HDMAP_PAYLOAD	            "{\"ty\":2,\"ts\":9999999999999,\"pld\":{\"tid\":1000,\"lon\":127.999999,\"lat\":37.510296,\"alt\":106,\"sp\":75,\"dop\":14,\"nos\":6,\"clt\":1507970678509}}"
...
void onConnect(void* context, MQTTAsync_successData* response)
{
    ...
    //////////////////////////////////////////////////
	// Publish HD MAp Perception Data Message
	//////////////////////////////////////////////////
    pubmsg.payload = HDMAP_PAYLOAD;
    pubmsg.payloadlen = strlen(HDMAP_PAYLOAD);
    pubmsg.qos = 0;
    pubmsg.retained = 0;
    deliveredtoken = 0;
    ...
    if ((rc = MQTTAsync_sendMessage(client, SENDING_TOPIC, &pubmsg, &opts)) != MQTTASYNC_SUCCESS)
	{
        ...
        printf("Sending a HDMAP PAYLOAD to Smart[Fleet] %s on topic %s\n\n",
